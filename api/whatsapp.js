...
function hashValue(value) {import { google } from "googleapis";
import { createHash } from "crypto";
...
⚡️🔥 Responde con el número elegido 🔥⚡️

🏆 0️⃣ VOLVER AL MENÚ 🏆`;
}

function platformMenu() {
  return `🎮⚡️ SELECCIONÁ TU PLATAFORMA ⚡️🎮
...
Elegí una opción correcta para continuar.
...
⚡️ Tu acceso está siendo preparado.
...
🔥⚡️ Apenas se acredite te avisaremos ⚡️🔥`);
    return;
  }
...
${platformMenu()}`);
    ...
    await sendWhatsApp(from, `💰🔥 EXCELENTE 🔥💰

⚡️ Ahora indicá el monto que vas a cargar.
...
⚡️🔥 Seguimos atentos a tu mensaje 🔥⚡️`);
    return;
  }

  if (estado === "RETIRO_SOLICITADO" || estado === "Retiro solicitado") {
    await updateUser(from, contactName, {
...
🚀 Seguimos con el retiro.`);
  ...
  if (estado === "RETIRO_TITULAR") {
    ...
    await sendWhatsApp(from, `🏦⚡️ BIEN RECIBIDO ⚡️🏦

🔥 Ahora enviame el banco o billetera.

🚀 Último paso para avanzar.`);
    return;
  }
...
⚡️ Tu información fue enviada al área administrativa.

🚀 Un administrador realizará la revisión correspondiente.
...
⚡️ Para continuar escribí tu nombre.

🚀 Vamos a preparar tu acceso.`);
      return;
    }
    ...
    if (text === "2") {
      ...
      await sendWhatsApp(from, `💳🔥 INICIEMOS LA CARGA 🔥💳

⚡️ Escribí tu usuario exactamente como figura en la plataforma.
...
🚀 Continuamos en el siguiente paso.`);
    ...
    if (text === "3") {
      ...
      await sendWhatsApp(from, `💸🔥 RETIRO EN PROCESO 🔥💸

⚡️ Escribí tu usuario.
...
Nombre WhatsApp: ${contactName}`, adminButtons(from));
      ...
      await sendWhatsApp(from, `👨‍💼🔥 ADMINISTRADOR NOTIFICADO 🔥👨‍💼

⚡️ Tu solicitud fue enviada correctamente.

🚀 También podés comunicarte por Telegram:

https://t.me/Eliamcorona

🔥 Un administrador responderá a la brevedad 🔥`);
      return;
    }
...
⚡️ Enterate de novedades, avisos y beneficios.
...
https://t.me/redcoronabet`);
    ...
    if (text === "6") {
      await sendWhatsApp(from, `🎁⚡️ BENEFICIOS ACTIVOS ⚡️🎁

🔥 Las novedades y beneficios se publican en el canal oficial.
...
⚡️ Ahora indicá el monto que querés retirar.
...
⚡️ Tu retiro fue enviado al área administrativa.

🚀 Estamos verificando usuario, plataforma y monto.

👑 Te notificaremos cuando el proceso avance.

🔥 Gracias por confiar en Red Corona Bett 🔥`);
    return;
  }
...
⚡️ Tu comprobante fue enviado al sector administrativo.

🚀 Se encuentra en revisión.

👑 Apenas sea validado recibirás la confirmación correspondiente.
